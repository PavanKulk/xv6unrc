...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
       b:	c7 44 24 04 a2 41 00 	movl   $0x41a2,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 9e 3d 00 00       	call   3db9 <printf>
  fd = open("echo", 0);
      1b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      22:	00 
      23:	c7 04 24 8c 41 00 00 	movl   $0x418c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
      3d:	c7 44 24 04 ad 41 00 	movl   $0x41ad,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 6c 3d 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 c0 41 00 00 	movl   $0x41c0,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
      7f:	c7 44 24 04 cd 41 00 	movl   $0x41cd,0x4(%esp)
      86:	00 
      87:	89 04 24             	mov    %eax,(%esp)
      8a:	e8 2a 3d 00 00       	call   3db9 <printf>
    exit();
      8f:	e8 a8 3b 00 00       	call   3c3c <exit>
  }
  printf(stdout, "open test ok\n");
      94:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
      99:	c7 44 24 04 eb 41 00 	movl   $0x41eb,0x4(%esp)
      a0:	00 
      a1:	89 04 24             	mov    %eax,(%esp)
      a4:	e8 10 3d 00 00       	call   3db9 <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
      b6:	c7 44 24 04 f9 41 00 	movl   $0x41f9,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 f3 3c 00 00       	call   3db9 <printf>
  fd = open("small", O_CREATE|O_RDWR);
      c6:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
      cd:	00 
      ce:	c7 04 24 0a 42 00 00 	movl   $0x420a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
      e8:	c7 44 24 04 10 42 00 	movl   $0x4210,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 c1 3c 00 00       	call   3db9 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     109:	c7 44 24 04 2b 42 00 	movl   $0x422b,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 a0 3c 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 47 42 00 	movl   $0x4247,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 54 42 00 	movl   $0x4254,0x4(%esp)
     151:	00 
     152:	89 04 24             	mov    %eax,(%esp)
     155:	e8 5f 3c 00 00       	call   3db9 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 78 42 00 	movl   $0x4278,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 84 42 00 	movl   $0x4284,0x4(%esp)
     192:	00 
     193:	89 04 24             	mov    %eax,(%esp)
     196:	e8 1e 3c 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     1b3:	c7 44 24 04 a8 42 00 	movl   $0x42a8,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 f6 3b 00 00       	call   3db9 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 0a 42 00 00 	movl   $0x420a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     1f0:	c7 44 24 04 b3 42 00 	movl   $0x42b3,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 b9 3b 00 00       	call   3db9 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     22e:	c7 44 24 04 cc 42 00 	movl   $0x42cc,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 7b 3b 00 00       	call   3db9 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     248:	c7 44 24 04 e7 42 00 	movl   $0x42e7,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 61 3b 00 00       	call   3db9 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 0a 42 00 00 	movl   $0x420a,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     27a:	c7 44 24 04 fa 42 00 	movl   $0x42fa,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 2f 3b 00 00       	call   3db9 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     294:	c7 44 24 04 07 43 00 	movl   $0x4307,0x4(%esp)
     29b:	00 
     29c:	89 04 24             	mov    %eax,(%esp)
     29f:	e8 15 3b 00 00       	call   3db9 <printf>
    exit();
     2a4:	e8 93 39 00 00       	call   3c3c <exit>
  }
  printf(stdout, "small file test ok\n");
     2a9:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     2ae:	c7 44 24 04 1c 43 00 	movl   $0x431c,0x4(%esp)
     2b5:	00 
     2b6:	89 04 24             	mov    %eax,(%esp)
     2b9:	e8 fb 3a 00 00       	call   3db9 <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     2cb:	c7 44 24 04 30 43 00 	movl   $0x4330,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 de 3a 00 00       	call   3db9 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     2db:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     2e2:	00 
     2e3:	c7 04 24 40 43 00 00 	movl   $0x4340,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     2fd:	c7 44 24 04 44 43 00 	movl   $0x4344,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 ac 3a 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 5e 43 00 	movl   $0x435e,0x4(%esp)
     35a:	00 
     35b:	89 04 24             	mov    %eax,(%esp)
     35e:	e8 56 3a 00 00       	call   3db9 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 40 43 00 00 	movl   $0x4340,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     3a3:	c7 44 24 04 7c 43 00 	movl   $0x437c,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 06 3a 00 00       	call   3db9 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 95 43 00 	movl   $0x4395,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 ad 39 00 00       	call   3db9 <printf>
        exit();
     ...
     41a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 b2 43 00 	movl   $0x43b2,0x4(%esp)
     42d:	00 
     42e:	89 04 24             	mov    %eax,(%esp)
     431:	e8 83 39 00 00       	call   3db9 <printf>
      exit();
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 40 43 00 00 	movl   $0x4340,(%esp)
     48f:	e8 f8 37 00 00       	call   3c8c <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     49d:	c7 44 24 04 e4 43 00 	movl   $0x43e4,0x4(%esp)
     4a4:	00 
     4a5:	89 04 24             	mov    %eax,(%esp)
     4a8:	e8 0c 39 00 00       	call   3db9 <printf>
    exit();
     4ad:	e8 8a 37 00 00       	call   3c3c <exit>
  }
  printf(stdout, "big files ok\n");
     4b2:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     4b7:	c7 44 24 04 f7 43 00 	movl   $0x43f7,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 f2 38 00 00       	call   3db9 <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     4d4:	c7 44 24 04 08 44 00 	movl   $0x4408,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 d5 38 00 00       	call   3db9 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     56f:	c7 44 24 04 30 44 00 	movl   $0x4430,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 3a 38 00 00       	call   3db9 <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     58c:	c7 44 24 04 56 44 00 	movl   $0x4456,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 1d 38 00 00       	call   3db9 <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 62 44 00 00 	movl   $0x4462,(%esp)
     5a3:	e8 fc 36 00 00       	call   3ca4 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     5b1:	c7 44 24 04 67 44 00 	movl   $0x4467,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 f8 37 00 00       	call   3db9 <printf>
    exit();
     5c1:	e8 76 36 00 00       	call   3c3c <exit>
  }

  if(chdir("dir0") < 0){
     5c6:	c7 04 24 62 44 00 00 	movl   $0x4462,(%esp)
     5cd:	e8 da 36 00 00       	call   3cac <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     5db:	c7 44 24 04 75 44 00 	movl   $0x4475,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 ce 37 00 00       	call   3db9 <printf>
    exit();
     5eb:	e8 4c 36 00 00       	call   3c3c <exit>
  }

  if(chdir("..") < 0){
     5f0:	c7 04 24 88 44 00 00 	movl   $0x4488,(%esp)
     5f7:	e8 b0 36 00 00       	call   3cac <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     605:	c7 44 24 04 8b 44 00 	movl   $0x448b,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 a4 37 00 00       	call   3db9 <printf>
    exit();
     615:	e8 22 36 00 00       	call   3c3c <exit>
  }

  if(unlink("dir0") < 0){
     61a:	c7 04 24 62 44 00 00 	movl   $0x4462,(%esp)
     621:	e8 66 36 00 00       	call   3c8c <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     62f:	c7 44 24 04 9c 44 00 	movl   $0x449c,0x4(%esp)
     636:	00 
     637:	89 04 24             	mov    %eax,(%esp)
     63a:	e8 7a 37 00 00       	call   3db9 <printf>
    exit();
     63f:	e8 f8 35 00 00       	call   3c3c <exit>
  }
  printf(stdout, "mkdir test\n");
     644:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     649:	c7 44 24 04 56 44 00 	movl   $0x4456,0x4(%esp)
     650:	00 
     651:	89 04 24             	mov    %eax,(%esp)
     654:	e8 60 37 00 00       	call   3db9 <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     666:	c7 44 24 04 b0 44 00 	movl   $0x44b0,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 43 37 00 00       	call   3db9 <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 cc 5e 00 	movl   $0x5ecc,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 8c 41 00 00 	movl   $0x418c,(%esp)
     685:	e8 ea 35 00 00       	call   3c74 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
     693:	c7 44 24 04 bb 44 00 	movl   $0x44bb,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 16 37 00 00       	call   3db9 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
     6c6:	00 
     6c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6ce:	e8 e6 36 00 00       	call   3db9 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     74f:	c7 44 24 04 dc 44 00 	movl   $0x44dc,0x4(%esp)
     756:	00 
     757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75e:	e8 56 36 00 00       	call   3db9 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c8:	c7 44 24 04 ea 44 00 	movl   $0x44ea,0x4(%esp)
     7cf:	00 
     7d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d7:	e8 dd 35 00 00       	call   3db9 <printf>
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 f8 44 00 	movl   $0x44f8,0x4(%esp)
     845:	00 
     846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84d:	e8 67 35 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 0f 45 00 	movl   $0x450f,0x4(%esp)
     86e:	00 
     86f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     876:	e8 3e 35 00 00       	call   3db9 <printf>
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 19 45 00 	movl   $0x4519,0x4(%esp)
     884:	00 
     885:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88c:	e8 28 35 00 00       	call   3db9 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 28 45 00 	movl   $0x4528,0x4(%esp)
     8a5:	00 
     8a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ad:	e8 07 35 00 00       	call   3db9 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 34 45 00 	movl   $0x4534,0x4(%esp)
     91d:	00 
     91e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     925:	e8 8f 34 00 00       	call   3db9 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 48 45 00 	movl   $0x4548,0x4(%esp)
     969:	00 
     96a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     971:	e8 43 34 00 00       	call   3db9 <printf>
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 5b 45 00 	movl   $0x455b,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 22 34 00 00       	call   3db9 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 64 45 00 	movl   $0x4564,0x4(%esp)
     9bf:	00 
     9c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c7:	e8 ed 33 00 00       	call   3db9 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 6d 45 00 	movl   $0x456d,0x4(%esp)
     9e2:	00 
     9e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9ea:	e8 ca 33 00 00       	call   3db9 <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     a15:	00 
     a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1d:	e8 97 33 00 00       	call   3db9 <printf>
      return;
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 86 45 00 	movl   $0x4586,0x4(%esp)
     a3b:	00 
     a3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a43:	e8 71 33 00 00       	call   3db9 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 96 45 00 	movl   $0x4596,0x4(%esp)
     a60:	00 
     a61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a68:	e8 4c 33 00 00       	call   3db9 <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 a3 45 00 	movl   $0x45a3,0x4(%esp)
     a7c:	00 
     a7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a84:	e8 30 33 00 00       	call   3db9 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 e3 35 00 00       	call   40a9 <malloc>
    ...
    while(m1){
     ...
     adf:	e8 8c 34 00 00       	call   3f70 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b2f:	e8 3c 34 00 00       	call   3f70 <free>
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 c7 45 00 	movl   $0x45c7,0x4(%esp)
     b3b:	00 
     b3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b43:	e8 71 32 00 00       	call   3db9 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5a:	c7 44 24 04 cf 45 00 	movl   $0x45cf,0x4(%esp)
     b61:	00 
     b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b69:	e8 4b 32 00 00       	call   3db9 <printf>

  unlink("sharedfd");
     b6e:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
     b75:	e8 12 31 00 00       	call   3c8c <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b81:	00 
     b82:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 e8 45 00 	movl   $0x45e8,0x4(%esp)
     b9e:	00 
     b9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba6:	e8 0e 32 00 00       	call   3db9 <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
     c10:	00 
     c11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c18:	e8 9c 31 00 00       	call   3db9 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 34 46 00 	movl   $0x4634,0x4(%esp)
     c6b:	00 
     c6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c73:	e8 41 31 00 00       	call   3db9 <printf>
  ...
  unlink("sharedfd");
     cf5:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d13:	c7 44 24 04 5f 46 00 	movl   $0x465f,0x4(%esp)
     d1a:	00 
     d1b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d22:	e8 92 30 00 00       	call   3db9 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d37:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
     d3e:	00 
     d3f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d46:	e8 6e 30 00 00       	call   3db9 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d58:	c7 44 24 04 81 46 00 	movl   $0x4681,0x4(%esp)
     d5f:	00 
     d60:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d67:	e8 4d 30 00 00       	call   3db9 <printf>

  unlink("f1");
     d6c:	c7 04 24 90 46 00 00 	movl   $0x4690,(%esp)
     d73:	e8 14 2f 00 00       	call   3c8c <unlink>
  unlink("f2");
     d78:	c7 04 24 93 46 00 00 	movl   $0x4693,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d92:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     d99:	00 
     d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     da1:	e8 13 30 00 00       	call   3db9 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     db1:	b8 90 46 00 00       	mov    $0x4690,%eax
     db6:	eb 05                	jmp    dbd <twofiles+0x6b>
     db8:	b8 93 46 00 00       	mov    $0x4693,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ddc:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
     de3:	00 
     de4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     deb:	e8 c9 2f 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e56:	c7 44 24 04 a5 46 00 	movl   $0x46a5,0x4(%esp)
     e5d:	00 
     e5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e65:	e8 4f 2f 00 00       	call   3db9 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea6:	b8 90 46 00 00       	mov    $0x4690,%eax
     eab:	eb 05                	jmp    eb2 <twofiles+0x160>
     ead:	b8 93 46 00 00       	mov    $0x4693,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef9:	74 19                	je     f14 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     efb:	c7 44 24 04 b6 46 00 	movl   $0x46b6,0x4(%esp)
     f02:	00 
     f03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f0a:	e8 aa 2e 00 00       	call   3db9 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f65:	c7 44 24 04 c2 46 00 	movl   $0x46c2,0x4(%esp)
     f6c:	00 
     f6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f74:	e8 40 2e 00 00       	call   3db9 <printf>
      exit();
  ...
  unlink("f1");
     f8c:	c7 04 24 90 46 00 00 	movl   $0x4690,(%esp)
     f93:	e8 f4 2c 00 00       	call   3c8c <unlink>
  unlink("f2");
     f98:	c7 04 24 93 46 00 00 	movl   $0x4693,(%esp)
     f9f:	e8 e8 2c 00 00       	call   3c8c <unlink>

  printf(1, "twofiles ok\n");
     fa4:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
     fab:	00 
     fac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fb3:	e8 01 2e 00 00       	call   3db9 <printf>
}
     fb8:	c9                   	leave  
     fb9:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fc0:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
     fc7:	00 
     fc8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcf:	e8 e5 2d 00 00       	call   3db9 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fe2:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     fe9:	00 
     fea:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ff1:	e8 c3 2d 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1043:	79 19                	jns    105e <createdelete+0xa4>
      printf(1, "create failed\n");
    1045:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
    104c:	00 
    104d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1054:	e8 60 2d 00 00       	call   3db9 <printf>
      exit();
    ...
    109a:	c7 44 24 04 f3 46 00 	movl   $0x46f3,0x4(%esp)
    10a1:	00 
    10a2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a9:	e8 0b 2d 00 00       	call   3db9 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1119:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    1120:	00 
    1121:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1128:	e8 8c 2c 00 00       	call   3db9 <printf>
      exit();
    ...
    114b:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    1152:	00 
    1153:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    115a:	e8 5a 2c 00 00       	call   3db9 <printf>
      exit();
    ...
    11b1:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    11b8:	00 
    11b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11c0:	e8 f4 2b 00 00       	call   3db9 <printf>
      exit();
    ...
    11e3:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    11ea:	00 
    11eb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11f2:	e8 c2 2b 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1255:	c7 44 24 04 48 47 00 	movl   $0x4748,0x4(%esp)
    125c:	00 
    125d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1264:	e8 50 2b 00 00       	call   3db9 <printf>
}
    1269:	c9                   	leave  
    126a:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1271:	c7 44 24 04 59 47 00 	movl   $0x4759,0x4(%esp)
    1278:	00 
    1279:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1280:	e8 34 2b 00 00       	call   3db9 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1285:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    128c:	00 
    128d:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
  ...
  if(fd < 0){
    ...
    12a2:	c7 44 24 04 75 47 00 	movl   $0x4775,0x4(%esp)
    12a9:	00 
    12aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b1:	e8 03 2b 00 00       	call   3db9 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12c2:	00 
    12c3:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
    12ca:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e8:	00 
    12e9:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    139d:	c7 44 24 04 cb 47 00 	movl   $0x47cb,0x4(%esp)
    13a4:	00 
    13a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13ac:	e8 08 2a 00 00       	call   3db9 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13c1:	c7 44 24 04 e2 47 00 	movl   $0x47e2,0x4(%esp)
    13c8:	00 
    13c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13d0:	e8 e4 29 00 00       	call   3db9 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13fa:	c7 44 24 04 f9 47 00 	movl   $0x47f9,0x4(%esp)
    1401:	00 
    1402:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1409:	e8 ab 29 00 00       	call   3db9 <printf>
    exit();
  ...
  unlink("unlinkread");
    141e:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
    1425:	e8 62 28 00 00       	call   3c8c <unlink>
  printf(1, "unlinkread ok\n");
    142a:	c7 44 24 04 12 48 00 	movl   $0x4812,0x4(%esp)
    1431:	00 
    1432:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1439:	e8 7b 29 00 00       	call   3db9 <printf>
}
    143e:	c9                   	leave  
    143f:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1446:	c7 44 24 04 21 48 00 	movl   $0x4821,0x4(%esp)
    144d:	00 
    144e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1455:	e8 5f 29 00 00       	call   3db9 <printf>

  unlink("lf1");
    145a:	c7 04 24 2b 48 00 00 	movl   $0x482b,(%esp)
    1461:	e8 26 28 00 00       	call   3c8c <unlink>
  unlink("lf2");
    1466:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    146d:	e8 1a 28 00 00       	call   3c8c <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1472:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1479:	00 
    147a:	c7 04 24 2b 48 00 00 	movl   $0x482b,(%esp)
  ...
  if(fd < 0){
    ...
    148f:	c7 44 24 04 33 48 00 	movl   $0x4833,0x4(%esp)
    1496:	00 
    1497:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149e:	e8 16 29 00 00       	call   3db9 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14af:	00 
    14b0:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
    14b7:	00 
    ...
    14c8:	c7 44 24 04 46 48 00 	movl   $0x4846,0x4(%esp)
    14cf:	00 
    14d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d7:	e8 dd 28 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1561:	00 
    1562:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
  ...
  if(fd < 0){
    ...
    1577:	c7 44 24 04 95 48 00 	movl   $0x4895,0x4(%esp)
    157e:	00 
    157f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1586:	e8 2e 28 00 00       	call   3db9 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15b0:	c7 44 24 04 a6 48 00 	movl   $0x48a6,0x4(%esp)
    15b7:	00 
    15b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bf:	e8 f5 27 00 00       	call   3db9 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d4:	c7 44 24 04 2f 48 00 	movl   $0x482f,0x4(%esp)
    15db:	00 
    15dc:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    15e3:	e8 b4 26 00 00       	call   3c9c <link>
    15e8:	85 c0                	test   %eax,%eax
    15ea:	78 19                	js     1605 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ec:	c7 44 24 04 b7 48 00 	movl   $0x48b7,0x4(%esp)
    15f3:	00 
    15f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15fb:	e8 b9 27 00 00       	call   3db9 <printf>
    exit();
    1600:	e8 37 26 00 00       	call   3c3c <exit>
  }

  unlink("lf2");
    1605:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    160c:	e8 7b 26 00 00       	call   3c8c <unlink>
  if(link("lf2", "lf1") >= 0){
    1611:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
    1618:	00 
    1619:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    1620:	e8 77 26 00 00       	call   3c9c <link>
    1625:	85 c0                	test   %eax,%eax
    1627:	78 19                	js     1642 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1629:	c7 44 24 04 d8 48 00 	movl   $0x48d8,0x4(%esp)
    1630:	00 
    1631:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1638:	e8 7c 27 00 00       	call   3db9 <printf>
    exit();
    163d:	e8 fa 25 00 00       	call   3c3c <exit>
  }

  if(link(".", "lf1") >= 0){
    1642:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
    1649:	00 
    164a:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
    1651:	e8 46 26 00 00       	call   3c9c <link>
    1656:	85 c0                	test   %eax,%eax
    1658:	78 19                	js     1673 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    165a:	c7 44 24 04 fd 48 00 	movl   $0x48fd,0x4(%esp)
    1661:	00 
    1662:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1669:	e8 4b 27 00 00       	call   3db9 <printf>
    exit();
    166e:	e8 c9 25 00 00       	call   3c3c <exit>
  }

  printf(1, "linktest ok\n");
    1673:	c7 44 24 04 19 49 00 	movl   $0x4919,0x4(%esp)
    167a:	00 
    167b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1682:	e8 32 27 00 00       	call   3db9 <printf>
}
    1687:	c9                   	leave  
    1688:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168f:	c7 44 24 04 26 49 00 	movl   $0x4926,0x4(%esp)
    1696:	00 
    1697:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169e:	e8 16 27 00 00       	call   3db9 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1702:	c7 04 24 36 49 00 00 	movl   $0x4936,(%esp)
    ...
    1745:	c7 04 24 36 49 00 00 	movl   $0x4936,(%esp)
    ...
    1776:	c7 44 24 04 39 49 00 	movl   $0x4939,0x4(%esp)
    177d:	00 
    177e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1785:	e8 2f 26 00 00       	call   3db9 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17da:	00 
    17db:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1840:	c7 44 24 04 55 49 00 	movl   $0x4955,0x4(%esp)
    1847:	00 
    1848:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184f:	e8 65 25 00 00       	call   3db9 <printf>
        exit();
    ...
    1872:	c7 44 24 04 6e 49 00 	movl   $0x496e,0x4(%esp)
    1879:	00 
    187a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1881:	e8 33 25 00 00       	call   3db9 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18d0:	c7 44 24 04 8c 49 00 	movl   $0x498c,0x4(%esp)
    18d7:	00 
    18d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18df:	e8 d5 24 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    190a:	79 19                	jns    1925 <concreate+0x29c>
      printf(1, "fork failed\n");
    190c:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    1913:	00 
    1914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    191b:	e8 99 24 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a2c:	c7 44 24 04 bd 49 00 	movl   $0x49bd,0x4(%esp)
    1a33:	00 
    1a34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a3b:	e8 79 23 00 00       	call   3db9 <printf>
}
    1a40:	c9                   	leave  
    1a41:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a48:	c7 44 24 04 cb 49 00 	movl   $0x49cb,0x4(%esp)
    1a4f:	00 
    1a50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a57:	e8 5d 23 00 00       	call   3db9 <printf>

  unlink("x");
    1a5c:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a76:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    1a7d:	00 
    1a7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a85:	e8 2f 23 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ae4:	00 
    1ae5:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
    ...
    1b16:	75 16                	jne    1b2e <linkunlink+0xec>
      link("cat", "x");
    1b18:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
    1b1f:	00 
    1b20:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
    1b27:	e8 70 21 00 00       	call   3c9c <link>
    1b2c:	eb 0c                	jmp    1b3a <linkunlink+0xf8>
    } else {
      unlink("x");
    1b2e:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b53:	c7 44 24 04 e0 49 00 	movl   $0x49e0,0x4(%esp)
    1b5a:	00 
    1b5b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b62:	e8 52 22 00 00       	call   3db9 <printf>
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b76:	c7 44 24 04 ef 49 00 	movl   $0x49ef,0x4(%esp)
    1b7d:	00 
    1b7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b85:	e8 2f 22 00 00       	call   3db9 <printf>
  unlink("bd");
    1b8a:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
    1b91:	e8 f6 20 00 00       	call   3c8c <unlink>

  fd = open("bd", O_CREATE);
    1b96:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b9d:	00 
    1b9e:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
  ...
  if(fd < 0){
    ...
    1bb3:	c7 44 24 04 ff 49 00 	movl   $0x49ff,0x4(%esp)
    1bba:	00 
    1bbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bc2:	e8 f2 21 00 00       	call   3db9 <printf>
    exit();
  ...
  unlink("bd");
    1c51:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1ca9:	c7 44 24 04 29 4a 00 	movl   $0x4a29,0x4(%esp)
    1cb0:	00 
    1cb1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cb8:	e8 fc 20 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1ccf:	c7 44 24 04 3e 4a 00 	movl   $0x4a3e,0x4(%esp)
    1cd6:	00 
    1cd7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cde:	e8 d6 20 00 00       	call   3db9 <printf>
}
    1ce3:	c9                   	leave  
    1ce4:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1ceb:	c7 44 24 04 49 4a 00 	movl   $0x4a49,0x4(%esp)
    1cf2:	00 
    1cf3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cfa:	e8 ba 20 00 00       	call   3db9 <printf>

  unlink("ff");
    1cff:	c7 04 24 56 4a 00 00 	movl   $0x4a56,(%esp)
    1d06:	e8 81 1f 00 00       	call   3c8c <unlink>
  if(mkdir("dd") != 0){
    1d0b:	c7 04 24 59 4a 00 00 	movl   $0x4a59,(%esp)
    1d12:	e8 8d 1f 00 00       	call   3ca4 <mkdir>
    1d17:	85 c0                	test   %eax,%eax
    1d19:	74 19                	je     1d34 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d1b:	c7 44 24 04 5c 4a 00 	movl   $0x4a5c,0x4(%esp)
    1d22:	00 
    1d23:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d2a:	e8 8a 20 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d3b:	00 
    1d3c:	c7 04 24 74 4a 00 00 	movl   $0x4a74,(%esp)
  ...
  if(fd < 0){
    ...
    1d51:	c7 44 24 04 7a 4a 00 	movl   $0x4a7a,0x4(%esp)
    1d58:	00 
    1d59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d60:	e8 54 20 00 00       	call   3db9 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d71:	00 
    1d72:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
    1d79:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1de9:	00 
    1dea:	c7 04 24 d8 4a 00 00 	movl   $0x4ad8,(%esp)
  ...
  if(fd < 0){
    ...
    1dff:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 a6 1f 00 00       	call   3db9 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e1f:	00 
    1e20:	c7 44 24 04 f9 4a 00 	movl   $0x4af9,0x4(%esp)
    1e27:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e45:	00 
    1e46:	c7 04 24 fc 4a 00 00 	movl   $0x4afc,(%esp)
  ...
  if(fd < 0){
    ...
    1e5b:	c7 44 24 04 08 4b 00 	movl   $0x4b08,0x4(%esp)
    1e62:	00 
    1e63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e6a:	e8 4a 1f 00 00       	call   3db9 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e7b:	00 
    1e7c:	c7 44 24 04 c0 86 00 	movl   $0x86c0,0x4(%esp)
    1e83:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e98:	0f b6 05 c0 86 00 00 	movzbl 0x86c0,%eax
    1e9f:	3c 66                	cmp    $0x66,%al
    1ea1:	74 19                	je     1ebc <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1ea3:	c7 44 24 04 21 4b 00 	movl   $0x4b21,0x4(%esp)
    1eaa:	00 
    1eab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1eb2:	e8 02 1f 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ffd:	00 
    1ffe:	c7 04 24 3c 4b 00 00 	movl   $0x4b3c,(%esp)
  ...
  if(fd < 0){
    ...
    2013:	c7 44 24 04 06 4c 00 	movl   $0x4c06,0x4(%esp)
    201a:	00 
    201b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2022:	e8 92 1d 00 00       	call   3db9 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2033:	00 
    2034:	c7 44 24 04 c0 86 00 	movl   $0x86c0,0x4(%esp)
    203b:	00 
    ...
    204c:	c7 44 24 04 1e 4c 00 	movl   $0x4c1e,0x4(%esp)
    2053:	00 
    2054:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    205b:	e8 59 1d 00 00       	call   3db9 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2431:	c7 44 24 04 98 4e 00 	movl   $0x4e98,0x4(%esp)
    2438:	00 
    2439:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2440:	e8 74 19 00 00       	call   3db9 <printf>

  unlink("bigwrite");
    2445:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2464:	00 
    2465:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
    ...
    247a:	c7 44 24 04 b0 4e 00 	movl   $0x4eb0,0x4(%esp)
    2481:	00 
    2482:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2489:	e8 2b 19 00 00       	call   3db9 <printf>
      exit();
    ...
    24a3:	c7 44 24 04 c0 86 00 	movl   $0x86c0,0x4(%esp)
    24aa:	00 
    ...
    24cf:	c7 44 24 04 c8 4e 00 	movl   $0x4ec8,0x4(%esp)
    24d6:	00 
    24d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24de:	e8 d6 18 00 00       	call   3db9 <printf>
        exit();
    ...
    unlink("bigwrite");
    24fd:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    251d:	c7 44 24 04 da 4e 00 	movl   $0x4eda,0x4(%esp)
    2524:	00 
    2525:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    252c:	e8 88 18 00 00       	call   3db9 <printf>
}
    2531:	c9                   	leave  
    2532:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2539:	c7 44 24 04 e7 4e 00 	movl   $0x4ee7,0x4(%esp)
    2540:	00 
    2541:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2548:	e8 6c 18 00 00       	call   3db9 <printf>

  unlink("bigfile");
    254d:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
    2554:	e8 33 17 00 00       	call   3c8c <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2559:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2560:	00 
    2561:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
  ...
  if(fd < 0){
    ...
    2576:	c7 44 24 04 fd 4e 00 	movl   $0x4efd,0x4(%esp)
    257d:	00 
    257e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2585:	e8 2f 18 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25a7:	c7 04 24 c0 86 00 00 	movl   $0x86c0,(%esp)
    25ae:	e8 e2 14 00 00       	call   3a95 <memset>
    if(write(fd, buf, 600) != 600){
    25b3:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ba:	00 
    25bb:	c7 44 24 04 c0 86 00 	movl   $0x86c0,0x4(%esp)
    25c2:	00 
    ...
    25d5:	c7 44 24 04 13 4f 00 	movl   $0x4f13,0x4(%esp)
    25dc:	00 
    25dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25e4:	e8 d0 17 00 00       	call   3db9 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    260a:	00 
    260b:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
  ...
  if(fd < 0){
    ...
    2620:	c7 44 24 04 29 4f 00 	movl   $0x4f29,0x4(%esp)
    2627:	00 
    2628:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    262f:	e8 85 17 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    264e:	00 
    264f:	c7 44 24 04 c0 86 00 	movl   $0x86c0,0x4(%esp)
    2656:	00 
    ...
    266b:	c7 44 24 04 3e 4f 00 	movl   $0x4f3e,0x4(%esp)
    2672:	00 
    2673:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    267a:	e8 3a 17 00 00       	call   3db9 <printf>
      exit();
    ...
    2693:	c7 44 24 04 53 4f 00 	movl   $0x4f53,0x4(%esp)
    269a:	00 
    269b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26a2:	e8 12 17 00 00       	call   3db9 <printf>
      exit();
    26a7:	e8 90 15 00 00       	call   3c3c <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    26ac:	0f b6 05 c0 86 00 00 	movzbl 0x86c0,%eax
    ...
    26c6:	0f b6 05 eb 87 00 00 	movzbl 0x87eb,%eax
    ...
    26e0:	c7 44 24 04 67 4f 00 	movl   $0x4f67,0x4(%esp)
    26e7:	00 
    26e8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26ef:	e8 c5 16 00 00       	call   3db9 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    271d:	c7 44 24 04 80 4f 00 	movl   $0x4f80,0x4(%esp)
    2724:	00 
    2725:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    272c:	e8 88 16 00 00       	call   3db9 <printf>
    exit();
    2731:	e8 06 15 00 00       	call   3c3c <exit>
  }
  unlink("bigfile");
    2736:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
    273d:	e8 4a 15 00 00       	call   3c8c <unlink>

  printf(1, "bigfile test ok\n");
    2742:	c7 44 24 04 9a 4f 00 	movl   $0x4f9a,0x4(%esp)
    2749:	00 
    274a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2751:	e8 63 16 00 00       	call   3db9 <printf>
}
    2756:	c9                   	leave  
    2757:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27cb:	00 
    27cc:	c7 04 24 38 50 00 00 	movl   $0x5038,(%esp)
  ...
  if(fd < 0){
    ...
    27e1:	c7 44 24 04 68 50 00 	movl   $0x5068,0x4(%esp)
    27e8:	00 
    27e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27f0:	e8 c4 15 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    280c:	00 
    280d:	c7 04 24 a8 50 00 00 	movl   $0x50a8,(%esp)
  ...
  if(fd < 0){
    ...
    2822:	c7 44 24 04 d8 50 00 	movl   $0x50d8,0x4(%esp)
    2829:	00 
    282a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2831:	e8 83 15 00 00       	call   3db9 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a2c:	c7 44 24 04 81 52 00 	movl   $0x5281,0x4(%esp)
    2a33:	00 
    2a34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a3b:	e8 79 13 00 00       	call   3db9 <printf>

  fd = open("dirfile", O_CREATE);
    2a40:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a47:	00 
    2a48:	c7 04 24 8e 52 00 00 	movl   $0x528e,(%esp)
  ...
  if(fd < 0){
    ...
    2a5d:	c7 44 24 04 96 52 00 	movl   $0x5296,0x4(%esp)
    2a64:	00 
    2a65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a6c:	e8 48 13 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ab1:	00 
    2ab2:	c7 04 24 c7 52 00 00 	movl   $0x52c7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ac7:	c7 44 24 04 d2 52 00 	movl   $0x52d2,0x4(%esp)
    2ace:	00 
    2acf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ad6:	e8 de 12 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae7:	00 
    2ae8:	c7 04 24 c7 52 00 00 	movl   $0x52c7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bc9:	00 
    2bca:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
  ...
  if(fd >= 0){
    ...
    2bdf:	c7 44 24 04 6c 53 00 	movl   $0x536c,0x4(%esp)
    2be6:	00 
    2be7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2bee:	e8 c6 11 00 00       	call   3db9 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c2e:	c7 44 24 04 8b 53 00 	movl   $0x538b,0x4(%esp)
    2c35:	00 
    2c36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c3d:	e8 77 11 00 00       	call   3db9 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c52:	c7 44 24 04 9f 53 00 	movl   $0x539f,0x4(%esp)
    2c59:	00 
    2c5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c61:	e8 53 11 00 00       	call   3db9 <printf>
}
    2c66:	c9                   	leave  
    2c67:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c6e:	c7 44 24 04 af 53 00 	movl   $0x53af,0x4(%esp)
    2c75:	00 
    2c76:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c7d:	e8 37 11 00 00       	call   3db9 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d2f:	00 
    2d30:	c7 04 24 ef 53 00 00 	movl   $0x53ef,(%esp)
    ...
    unlink("xx");
    2d50:	c7 04 24 ef 53 00 00 	movl   $0x53ef,(%esp)
  ...
  chdir("/");
    2d6a:	c7 04 24 12 52 00 00 	movl   $0x5212,(%esp)
    2d71:	e8 36 0f 00 00       	call   3cac <chdir>
  printf(1, "empty file name OK\n");
    2d76:	c7 44 24 04 f2 53 00 	movl   $0x53f2,0x4(%esp)
    2d7d:	00 
    2d7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d85:	e8 2f 10 00 00       	call   3db9 <printf>
}
    2d8a:	c9                   	leave  
    2d8b:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d92:	c7 44 24 04 06 54 00 	movl   $0x5406,0x4(%esp)
    2d99:	00 
    2d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2da1:	e8 13 10 00 00       	call   3db9 <printf>
    ...
    2dc3:	e8 74 0e 00 00       	call   3c3c <exit>
{
  ...
  if(n == 1000){
    ...
    2de1:	c7 44 24 04 14 54 00 	movl   $0x5414,0x4(%esp)
    2de8:	00 
    2de9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2df0:	e8 c4 0f 00 00       	call   3db9 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2e03:	c7 44 24 04 36 54 00 	movl   $0x5436,0x4(%esp)
    2e0a:	00 
    2e0b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e12:	e8 a2 0f 00 00       	call   3db9 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e30:	c7 44 24 04 4a 54 00 	movl   $0x544a,0x4(%esp)
    2e37:	00 
    2e38:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e3f:	e8 75 0f 00 00       	call   3db9 <printf>
    exit();
    2e44:	e8 f3 0d 00 00       	call   3c3c <exit>
  }
  
  printf(1, "fork test OK\n");
    2e49:	c7 44 24 04 5d 54 00 	movl   $0x545d,0x4(%esp)
    2e50:	00 
    2e51:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e58:	e8 5c 0f 00 00       	call   3db9 <printf>
}
    2e5d:	c9                   	leave  
    2e5e:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e69:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    2e6e:	c7 44 24 04 6b 54 00 	movl   $0x546b,0x4(%esp)
    2e75:	00 
    2e76:	89 04 24             	mov    %eax,(%esp)
    2e79:	e8 3b 0f 00 00       	call   3db9 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2ebc:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    ...
    2ed6:	c7 44 24 04 76 54 00 	movl   $0x5476,0x4(%esp)
    2edd:	00 
    2ede:	89 04 24             	mov    %eax,(%esp)
    2ee1:	e8 d3 0e 00 00       	call   3db9 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f15:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    2f1a:	c7 44 24 04 91 54 00 	movl   $0x5491,0x4(%esp)
    2f21:	00 
    2f22:	89 04 24             	mov    %eax,(%esp)
    2f25:	e8 8f 0e 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f58:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    2f5d:	c7 44 24 04 a8 54 00 	movl   $0x54a8,0x4(%esp)
    2f64:	00 
    2f65:	89 04 24             	mov    %eax,(%esp)
    2f68:	e8 4c 0e 00 00       	call   3db9 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2fb8:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    2fbd:	c7 44 24 04 c4 54 00 	movl   $0x54c4,0x4(%esp)
    2fc4:	00 
    2fc5:	89 04 24             	mov    %eax,(%esp)
    2fc8:	e8 ec 0d 00 00       	call   3db9 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3003:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    3008:	c7 44 24 04 02 55 00 	movl   $0x5502,0x4(%esp)
    300f:	00 
    3010:	89 04 24             	mov    %eax,(%esp)
    3013:	e8 a1 0d 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    3039:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    ...
    304c:	c7 44 24 04 20 55 00 	movl   $0x5520,0x4(%esp)
    3053:	00 
    3054:	89 04 24             	mov    %eax,(%esp)
    3057:	e8 5d 0d 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    30a0:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    ...
    30b3:	c7 44 24 04 58 55 00 	movl   $0x5558,0x4(%esp)
    30ba:	00 
    30bb:	89 04 24             	mov    %eax,(%esp)
    30be:	e8 f6 0c 00 00       	call   3db9 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30d2:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    30d7:	c7 44 24 04 80 55 00 	movl   $0x5580,0x4(%esp)
    30de:	00 
    30df:	89 04 24             	mov    %eax,(%esp)
    30e2:	e8 d2 0c 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a){
    ...
    3123:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    ...
    3136:	c7 44 24 04 b0 55 00 	movl   $0x55b0,0x4(%esp)
    313d:	00 
    313e:	89 04 24             	mov    %eax,(%esp)
    3141:	e8 73 0c 00 00       	call   3db9 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    316a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    316f:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    3176:	00 
    3177:	89 04 24             	mov    %eax,(%esp)
    317a:	e8 3a 0c 00 00       	call   3db9 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31eb:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
    31f2:	00 
    31f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31fa:	e8 ba 0b 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3250:	00 
    3251:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
    3258:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32f2:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    32f7:	c7 44 24 04 ea 55 00 	movl   $0x55ea,0x4(%esp)
    32fe:	00 
    32ff:	89 04 24             	mov    %eax,(%esp)
    3302:	e8 b2 0a 00 00       	call   3db9 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    333a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    333f:	c7 44 24 04 05 56 00 	movl   $0x5605,0x4(%esp)
    3346:	00 
    3347:	89 04 24             	mov    %eax,(%esp)
    334a:	e8 6a 0a 00 00       	call   3db9 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3389:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    338e:	c7 44 24 04 13 56 00 	movl   $0x5613,0x4(%esp)
    3395:	00 
    3396:	89 04 24             	mov    %eax,(%esp)
    3399:	e8 1b 0a 00 00       	call   3db9 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33fb:	c7 04 24 22 56 00 00 	movl   $0x5622,(%esp)
    3402:	e8 95 08 00 00       	call   3c9c <link>
    3407:	83 f8 ff             	cmp    $0xffffffff,%eax
    340a:	74 1a                	je     3426 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    340c:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    3411:	c7 44 24 04 2d 56 00 	movl   $0x562d,0x4(%esp)
    3418:	00 
    3419:	89 04 24             	mov    %eax,(%esp)
    341c:	e8 98 09 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    3439:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    343e:	c7 44 24 04 46 56 00 	movl   $0x5646,0x4(%esp)
    3445:	00 
    3446:	89 04 24             	mov    %eax,(%esp)
    3449:	e8 6b 09 00 00       	call   3db9 <printf>
}
    344e:	c9                   	leave  
    344f:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3456:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    345b:	c7 44 24 04 53 56 00 	movl   $0x5653,0x4(%esp)
    3462:	00 
    3463:	89 04 24             	mov    %eax,(%esp)
    3466:	e8 4e 09 00 00       	call   3db9 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    346b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3472:	eb 2d                	jmp    34a1 <bsstest+0x51>
    if(uninit[i] != '\0'){
    3474:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3477:	05 a0 5f 00 00       	add    $0x5fa0,%eax
    347c:	0f b6 00             	movzbl (%eax),%eax
    347f:	84 c0                	test   %al,%al
    3481:	74 1a                	je     349d <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3483:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    3488:	c7 44 24 04 5d 56 00 	movl   $0x565d,0x4(%esp)
    348f:	00 
    3490:	89 04 24             	mov    %eax,(%esp)
    3493:	e8 21 09 00 00       	call   3db9 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    34ab:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    34b0:	c7 44 24 04 6e 56 00 	movl   $0x566e,0x4(%esp)
    34b7:	00 
    34b8:	89 04 24             	mov    %eax,(%esp)
    34bb:	e8 f9 08 00 00       	call   3db9 <printf>
}
    34c0:	c9                   	leave  
    34c1:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34c8:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
  ...
  if(pid == 0){
    ...
    34f2:	c7 04 85 00 5f 00 00 	movl   $0x5688,0x5f00(,%eax,4)
    34f9:	88 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3505:	7e e8                	jle    34ef <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    3507:	c7 05 7c 5f 00 00 00 	movl   $0x0,0x5f7c
    350e:	00 00 00 
    printf(stdout, "bigarg test\n");
    3511:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    3516:	c7 44 24 04 65 57 00 	movl   $0x5765,0x4(%esp)
    351d:	00 
    351e:	89 04 24             	mov    %eax,(%esp)
    3521:	e8 93 08 00 00       	call   3db9 <printf>
    exec("echo", args);
    3526:	c7 44 24 04 00 5f 00 	movl   $0x5f00,0x4(%esp)
    352d:	00 
    352e:	c7 04 24 8c 41 00 00 	movl   $0x418c,(%esp)
    3535:	e8 3a 07 00 00       	call   3c74 <exec>
    printf(stdout, "bigarg test ok\n");
    353a:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    353f:	c7 44 24 04 72 57 00 	movl   $0x5772,0x4(%esp)
    3546:	00 
    3547:	89 04 24             	mov    %eax,(%esp)
    354a:	e8 6a 08 00 00       	call   3db9 <printf>
    fd = open("bigarg-ok", O_CREATE);
    354f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3556:	00 
    3557:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
    ...
    357c:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    3581:	c7 44 24 04 82 57 00 	movl   $0x5782,0x4(%esp)
    3588:	00 
    3589:	89 04 24             	mov    %eax,(%esp)
    358c:	e8 28 08 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    35a2:	00 
    35a3:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
  ...
  if(fd < 0){
    ...
    35b8:	a1 e0 5e 00 00       	mov    0x5ee0,%eax
    35bd:	c7 44 24 04 9b 57 00 	movl   $0x579b,0x4(%esp)
    35c4:	00 
    35c5:	89 04 24             	mov    %eax,(%esp)
    35c8:	e8 ec 07 00 00       	call   3db9 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35dd:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35f9:	c7 44 24 04 b0 57 00 	movl   $0x57b0,0x4(%esp)
    3600:	00 
    3601:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3608:	e8 ac 07 00 00       	call   3db9 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36e9:	c7 44 24 04 bd 57 00 	movl   $0x57bd,0x4(%esp)
    36f0:	00 
    36f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36f8:	e8 bc 06 00 00       	call   3db9 <printf>
    ...
    3720:	c7 44 24 04 c9 57 00 	movl   $0x57c9,0x4(%esp)
    3727:	00 
    3728:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    372f:	e8 85 06 00 00       	call   3db9 <printf>
    close(fd);
    if(total == 0)
      break;
  }
  ...
  while(nfiles >= 0){
    ...
    3747:	00 
    3748:	c7 44 24 04 c0 86 00 	movl   $0x86c0,0x4(%esp)
    374f:	00 
    ...
    377b:	c7 44 24 04 d9 57 00 	movl   $0x57d9,0x4(%esp)
    3782:	00 
    3783:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    378a:	e8 2a 06 00 00       	call   3db9 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3894:	c7 44 24 04 e9 57 00 	movl   $0x57e9,0x4(%esp)
    389b:	00 
    389c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    38a3:	e8 11 05 00 00       	call   3db9 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38b1:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
    38b6:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38bc:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38c1:	a3 e4 5e 00 00       	mov    %eax,0x5ee4
  return randstate;
    38c6:	a1 e4 5e 00 00       	mov    0x5ee4,%eax
}
    38cb:	5d                   	pop    %ebp
    38cc:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3922:	00 
    3923:	c7 04 24 13 58 00 00 	movl   $0x5813,(%esp)
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3cfd:	e8 5a ff ff ff       	call   3c5c <write>
}
    3d02:	c9                   	leave  
    3d03:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d4a:	0f b6 80 e8 5e 00 00 	movzbl 0x5ee8(%eax),%eax
    3d51:	8d 4d dc             	lea    -0x24(%ebp),%ecx
    3d54:	8b 55 f4             	mov    -0xc(%ebp),%edx
    3d57:	01 ca                	add    %ecx,%edx
    3d59:	88 02                	mov    %al,(%edx)
    3d5b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d5f:	8b 55 10             	mov    0x10(%ebp),%edx
    3d62:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d65:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d68:	ba 00 00 00 00       	mov    $0x0,%edx
    3d6d:	f7 75 d4             	divl   -0x2c(%ebp)
    3d70:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d73:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d77:	75 c2                	jne    3d3b <printint+0x37>
  if(neg)
    3d79:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d7d:	74 2e                	je     3dad <printint+0xa9>
    buf[i++] = '-';
    3d7f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    3d82:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d85:	01 d0                	add    %edx,%eax
    3d87:	c6 00 2d             	movb   $0x2d,(%eax)
    3d8a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3d8e:	eb 1d                	jmp    3dad <printint+0xa9>
    putc(fd, buf[i]);
    3d90:	8d 55 dc             	lea    -0x24(%ebp),%edx
    3d93:	8b 45 f4             	mov    -0xc(%ebp),%eax
    ...
    3da8:	e8 2f ff ff ff       	call   3cdc <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dad:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3db1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3db5:	79 d9                	jns    3d90 <printint+0x8c>
    putc(fd, buf[i]);
}
    3db7:	c9                   	leave  
    3db8:	c3                   	ret    
...
{
    3db9:	55                   	push   %ebp
    3dba:	89 e5                	mov    %esp,%ebp
    3dbc:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dbf:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3dc6:	8d 45 0c             	lea    0xc(%ebp),%eax
    3dc9:	83 c0 04             	add    $0x4,%eax
    3dcc:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3dcf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dd6:	e9 7d 01 00 00       	jmp    3f58 <printf+0x19f>
    c = fmt[i] & 0xff;
    3ddb:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dde:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3de1:	01 d0                	add    %edx,%eax
    3de3:	0f b6 00             	movzbl (%eax),%eax
    3de6:	0f be c0             	movsbl %al,%eax
    3de9:	25 ff 00 00 00       	and    $0xff,%eax
    3dee:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3df1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3df5:	75 2c                	jne    3e23 <printf+0x6a>
      if(c == '%'){
    3df7:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3dfb:	75 0c                	jne    3e09 <printf+0x50>
        state = '%';
    3dfd:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e04:	e9 4b 01 00 00       	jmp    3f54 <printf+0x19b>
      } else {
        putc(fd, c);
    3e09:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e0c:	0f be c0             	movsbl %al,%eax
    3e0f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e13:	8b 45 08             	mov    0x8(%ebp),%eax
    3e16:	89 04 24             	mov    %eax,(%esp)
    3e19:	e8 be fe ff ff       	call   3cdc <putc>
    3e1e:	e9 31 01 00 00       	jmp    3f54 <printf+0x19b>
      }
    } else if(state == '%'){
    3e23:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e27:	0f 85 27 01 00 00    	jne    3f54 <printf+0x19b>
      if(c == 'd'){
    3e2d:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e31:	75 2d                	jne    3e60 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e33:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e36:	8b 00                	mov    (%eax),%eax
    3e38:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e3f:	00 
    3e40:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e47:	00 
    3e48:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e4c:	8b 45 08             	mov    0x8(%ebp),%eax
    3e4f:	89 04 24             	mov    %eax,(%esp)
    3e52:	e8 ad fe ff ff       	call   3d04 <printint>
        ap++;
    3e57:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e5b:	e9 ed 00 00 00       	jmp    3f4d <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e60:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e64:	74 06                	je     3e6c <printf+0xb3>
    3e66:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e6a:	75 2d                	jne    3e99 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e6c:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e6f:	8b 00                	mov    (%eax),%eax
    3e71:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e78:	00 
    3e79:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e80:	00 
    3e81:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e85:	8b 45 08             	mov    0x8(%ebp),%eax
    3e88:	89 04 24             	mov    %eax,(%esp)
    3e8b:	e8 74 fe ff ff       	call   3d04 <printint>
        ap++;
    3e90:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e94:	e9 b4 00 00 00       	jmp    3f4d <printf+0x194>
      } else if(c == 's'){
    3e99:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3e9d:	75 46                	jne    3ee5 <printf+0x12c>
        s = (char*)*ap;
    3e9f:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3ea2:	8b 00                	mov    (%eax),%eax
    3ea4:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3ea7:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3eab:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3eaf:	75 27                	jne    3ed8 <printf+0x11f>
          s = "(null)";
    3eb1:	c7 45 f4 4e 58 00 00 	movl   $0x584e,-0xc(%ebp)
        while(*s != 0){
    3eb8:	eb 1e                	jmp    3ed8 <printf+0x11f>
          putc(fd, *s);
    3eba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ebd:	0f b6 00             	movzbl (%eax),%eax
    3ec0:	0f be c0             	movsbl %al,%eax
    3ec3:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ec7:	8b 45 08             	mov    0x8(%ebp),%eax
    3eca:	89 04 24             	mov    %eax,(%esp)
    3ecd:	e8 0a fe ff ff       	call   3cdc <putc>
          s++;
    3ed2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3ed6:	eb 01                	jmp    3ed9 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3ee1:	75 d7                	jne    3eba <printf+0x101>
    3ee3:	eb 68                	jmp    3f4d <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3ee5:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3ee9:	75 1d                	jne    3f08 <printf+0x14f>
        putc(fd, *ap);
    3eeb:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3eee:	8b 00                	mov    (%eax),%eax
    3ef0:	0f be c0             	movsbl %al,%eax
    3ef3:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ef7:	8b 45 08             	mov    0x8(%ebp),%eax
    3efa:	89 04 24             	mov    %eax,(%esp)
    3efd:	e8 da fd ff ff       	call   3cdc <putc>
        ap++;
    3f02:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f06:	eb 45                	jmp    3f4d <printf+0x194>
      } else if(c == '%'){
    3f08:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f0c:	75 17                	jne    3f25 <printf+0x16c>
        putc(fd, c);
    3f0e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f11:	0f be c0             	movsbl %al,%eax
    3f14:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f18:	8b 45 08             	mov    0x8(%ebp),%eax
    3f1b:	89 04 24             	mov    %eax,(%esp)
    3f1e:	e8 b9 fd ff ff       	call   3cdc <putc>
    3f23:	eb 28                	jmp    3f4d <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f25:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f2c:	00 
    3f2d:	8b 45 08             	mov    0x8(%ebp),%eax
    3f30:	89 04 24             	mov    %eax,(%esp)
    3f33:	e8 a4 fd ff ff       	call   3cdc <putc>
        putc(fd, c);
    3f38:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f3b:	0f be c0             	movsbl %al,%eax
    3f3e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f42:	8b 45 08             	mov    0x8(%ebp),%eax
    3f45:	89 04 24             	mov    %eax,(%esp)
    3f48:	e8 8f fd ff ff       	call   3cdc <putc>
      }
      state = 0;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f54:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    3f58:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f5e:	01 d0                	add    %edx,%eax
    3f60:	0f b6 00             	movzbl (%eax),%eax
    3f63:	84 c0                	test   %al,%al
    3f65:	0f 85 70 fe ff ff    	jne    3ddb <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    3f73:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3f76:	8b 45 08             	mov    0x8(%ebp),%eax
    3f79:	83 e8 08             	sub    $0x8,%eax
    3f7c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f7f:	a1 88 5f 00 00       	mov    0x5f88,%eax
    3f84:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3f87:	eb 24                	jmp    3fad <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3f89:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f8c:	8b 00                	mov    (%eax),%eax
    3f8e:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3f91:	77 12                	ja     3fa5 <free+0x35>
    3f93:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3f96:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3f99:	77 24                	ja     3fbf <free+0x4f>
    3f9b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f9e:	8b 00                	mov    (%eax),%eax
    3fa0:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fa3:	77 1a                	ja     3fbf <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3fa8:	8b 00                	mov    (%eax),%eax
    3faa:	89 45 fc             	mov    %eax,-0x4(%ebp)
    3fad:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fb0:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fb3:	76 d4                	jbe    3f89 <free+0x19>
    3fb5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fb8:	8b 00                	mov    (%eax),%eax
    3fba:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fbd:	76 ca                	jbe    3f89 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3fbf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fc2:	8b 40 04             	mov    0x4(%eax),%eax
    3fc5:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    3fcc:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fcf:	01 c2                	add    %eax,%edx
    3fd1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fd4:	8b 00                	mov    (%eax),%eax
    3fd6:	39 c2                	cmp    %eax,%edx
    3fd8:	75 24                	jne    3ffe <free+0x8e>
  ...
  if(p + p->s.size == bp){
    ...
    400e:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4015:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4018:	01 d0                	add    %edx,%eax
    401a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    401d:	75 20                	jne    403f <free+0xcf>
    p->s.size += bp->s.size;
    401f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4022:	8b 50 04             	mov    0x4(%eax),%edx
    4025:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4028:	8b 40 04             	mov    0x4(%eax),%eax
    402b:	01 c2                	add    %eax,%edx
    402d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4030:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4033:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4036:	8b 10                	mov    (%eax),%edx
    4038:	8b 45 fc             	mov    -0x4(%ebp),%eax
    403b:	89 10                	mov    %edx,(%eax)
    403d:	eb 08                	jmp    4047 <free+0xd7>
  } else
    p->s.ptr = bp;
    403f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4042:	8b 55 f8             	mov    -0x8(%ebp),%edx
    4045:	89 10                	mov    %edx,(%eax)
  freep = p;
    4047:	8b 45 fc             	mov    -0x4(%ebp),%eax
    404a:	a3 88 5f 00 00       	mov    %eax,0x5f88
}
    404f:	c9                   	leave  
    4050:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    4057:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    405e:	77 07                	ja     4067 <morecore+0x16>
    nu = 4096;
    4060:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4067:	8b 45 08             	mov    0x8(%ebp),%eax
    406a:	c1 e0 03             	shl    $0x3,%eax
    406d:	89 04 24             	mov    %eax,(%esp)
    4070:	e8 4f fc ff ff       	call   3cc4 <sbrk>
    4075:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4078:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    407c:	75 07                	jne    4085 <morecore+0x34>
    return 0;
    407e:	b8 00 00 00 00       	mov    $0x0,%eax
    4083:	eb 22                	jmp    40a7 <morecore+0x56>
  hp = (Header*)p;
  ...
  free((void*)(hp + 1));
    ...
    409d:	e8 ce fe ff ff       	call   3f70 <free>
  return freep;
    40a2:	a1 88 5f 00 00       	mov    0x5f88,%eax
}
    40a7:	c9                   	leave  
    40a8:	c3                   	ret    
...
{
    40a9:	55                   	push   %ebp
    40aa:	89 e5                	mov    %esp,%ebp
    40ac:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    40af:	8b 45 08             	mov    0x8(%ebp),%eax
    40b2:	83 c0 07             	add    $0x7,%eax
    40b5:	c1 e8 03             	shr    $0x3,%eax
    40b8:	83 c0 01             	add    $0x1,%eax
    40bb:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40be:	a1 88 5f 00 00       	mov    0x5f88,%eax
    40c3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40c6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40ca:	75 23                	jne    40ef <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40cc:	c7 45 f0 80 5f 00 00 	movl   $0x5f80,-0x10(%ebp)
    40d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d6:	a3 88 5f 00 00       	mov    %eax,0x5f88
    40db:	a1 88 5f 00 00       	mov    0x5f88,%eax
    40e0:	a3 80 5f 00 00       	mov    %eax,0x5f80
    base.s.size = 0;
    40e5:	c7 05 84 5f 00 00 00 	movl   $0x0,0x5f84
    40ec:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    40fd:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4100:	72 4d                	jb     414f <malloc+0xa6>
      if(p->s.size == nunits)
    4102:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4105:	8b 40 04             	mov    0x4(%eax),%eax
    4108:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    410b:	75 0c                	jne    4119 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    410d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4110:	8b 10                	mov    (%eax),%edx
    4112:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4115:	89 10                	mov    %edx,(%eax)
    4117:	eb 26                	jmp    413f <malloc+0x96>
      else {
        p->s.size -= nunits;
    4119:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411c:	8b 40 04             	mov    0x4(%eax),%eax
    411f:	89 c2                	mov    %eax,%edx
    4121:	2b 55 ec             	sub    -0x14(%ebp),%edx
    4124:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4127:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    412a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    412d:	8b 40 04             	mov    0x4(%eax),%eax
    4130:	c1 e0 03             	shl    $0x3,%eax
    4133:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4136:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4139:	8b 55 ec             	mov    -0x14(%ebp),%edx
    413c:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    413f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4142:	a3 88 5f 00 00       	mov    %eax,0x5f88
      return (void*)(p + 1);
    4147:	8b 45 f4             	mov    -0xc(%ebp),%eax
    414a:	83 c0 08             	add    $0x8,%eax
    414d:	eb 38                	jmp    4187 <malloc+0xde>
    }
    if(p == freep)
    414f:	a1 88 5f 00 00       	mov    0x5f88,%eax
    4154:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4157:	75 1b                	jne    4174 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4159:	8b 45 ec             	mov    -0x14(%ebp),%eax
    415c:	89 04 24             	mov    %eax,(%esp)
    415f:	e8 ed fe ff ff       	call   4051 <morecore>
    4164:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4167:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    416b:	75 07                	jne    4174 <malloc+0xcb>
        return 0;
    416d:	b8 00 00 00 00       	mov    $0x0,%eax
    4172:	eb 13                	jmp    4187 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4177:	89 45 f0             	mov    %eax,-0x10(%ebp)
    417a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    ...
    4182:	e9 70 ff ff ff       	jmp    40f7 <malloc+0x4e>
}
    4187:	c9                   	leave  
    4188:	c3                   	ret    
